  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {MANAGERS.map((m) => (
          <button key={m.name} onClick={() => { setAbilityTooltip(null); setSelected(selected?.name === m.name ? null : m); }}
      ...
      {selected && (
        <div className="rounded-2xl border border-accent/30 overflow-hidden"
          ...
          <div className="px-6 py-4 border-b border-border/60 flex items-center justify-between gap-4">
            ...
            <button
              onClick={() => { setAbilityTooltip(null); setSelected(null); }}
